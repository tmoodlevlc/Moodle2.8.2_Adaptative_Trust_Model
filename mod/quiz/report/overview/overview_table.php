...
/////////////////////////////////MODELO DE CONFIANZA EXAMEN/////////////////////////////////////////////////////////
	...
	public function col_trust($attempt) {
		...
		//Si el usuario no realizo ningun intento
		if (!$attempt->attempt){
			$attempt_id = 0;
		}
		//Controla si posee varias roles, no calificar
		if($user_id != $attempt_user){
			
			//Verifica si ya evaluo el usuario a la tarea
			$count = $DB->count_records('trust_f1w1_history_quiz', array('user_id' => $user_id,'course_id' => $course_id,'quiz_id' => $quiz_id,

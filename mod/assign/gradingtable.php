...
class assign_grading_table extends table_sql implements renderable {
    ...
    public function __construct(assign $assignment,
		...
		//Inserta columna Modelo Confianza en la tabla
         if (!$this->is_downloading()) {
            $columns[] = 'trust';
			$headers[] = get_string('pluginname', 'block_trust_model').'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
        }
		///////////////////////////////////////////////////////////////7
		...
		////////////////////////////MODELO DE CONFIANZA TAREA/////////////////////////
		//Inactiva el enlace en la  cabecera de la columna Modelo de confianza
		$this->no_sorting('trust');
		////////////////////////////////////////////////////////////////////////////
	...
	public function col_trust($row) {
		...
		$assign_user=$row->userid;
		//Variables Modelo de Confianza
		$like= get_string('like', 'block_trust_model');
		$not_like= get_string('not_like', 'block_trust_model');
		//Controla si posee varias roles, no calificar
		if($user_id != $assign_user){
			//Verifica si ya evaluo el usuario a la tarea

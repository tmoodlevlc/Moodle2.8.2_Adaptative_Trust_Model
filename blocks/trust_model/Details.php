...
//Impresion
$url = new moodle_url('/blocks/trust_model/Details.php', array('u' => $USER -> id, 'c' => $course_id));
$PAGE->set_url($url);
...
//Grafico
$url_grafic = new moodle_url('/blocks/trust_model/graphic/index.php', array('us'=>$user_id,'u'=>$user_id, 'c'=>$course_id));
